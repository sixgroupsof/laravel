    ...
    !function () {
        ...
        s.setPath('https://dup.baidustatic.com/'), s.define({
            ...
            onMessageHandler: function (t) {
                ...
                e && e.placement && e.placement.update && e.queryid && e.tuid && (this.updateInfo(e), e.tuid.indexOf("u") > -1 && e.noadx && parseInt(e.noadx, 10) && 3 !== parseInt(e.noadx, 10) && this.unionAdIsAvailable(e))
            },
            ...
            unionAdIsAvailable: function (t) {
                ...
                if (e) {
                    var i = this.dom.g(e.containerId), n = s.using("dup.business.viewWatch"),
                        o = e.response && e.response.placement && e.response.placement.complement_type;
                    o && 7 === o && i && (i.parentNode.removeChild(i), n.unregisetViewWatch(e))
                }
            },
            ...
            computeViewStatus: function (t) {
                ...
                if (this.winFocused) try {
                    var r = this.style.getClientWidth(this.win), a = this.style.getClientHeight(this.win),
                        d = this.getPosition(i), l = this.style.getOuterWidth(i), c = this.style.getOuterHeight(i);
                    s = this.getOpacity(t), n = d.top >= 0 && d.bottom <= a && d.left >= 0 && d.left <= r;
                    var h = d.top > 0 ? d.top : 0, u = d.bottom > a ? a : d.bottom, p = d.left > 0 ? d.left : 0,
                        m = d.right > r ? r : d.right, f = l * c;
                    if (u > h && m > p) {
                        var g = (u - h) * (m - p);
                        o = g > .5 * f
                    }
            ...
            painterLoadedCallback: function (t, e, i) {
                var n = i || s.using(t);
                n && (n.render(e), t && t.indexOf("mobile") > -1 && this.viewWatch.regisetViewWatch(e))
            }
        });
