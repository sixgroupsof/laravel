...
@section('content')
    <div id="page-main" class="container">
        <link rel="stylesheet" href="~../public/css/daybook" type="text/css">
        <style type="text/css">
            .tip {
                cursor: help;
                padding: 9px;
        ...
        <div id="page-main" class="container">
            ...
            <div class="main" style="width: auto">
                <form action="{{url('daybook/save')}}" method="post" accept-charset="utf-8" class="col-md-4"
                    ...
                    <a id="whats_expired" class="tip"
                       abc="给日记本设置一个完结日期，日记本完结后你才能浏览该日记本的所有日记，在此之前，每天凌晨零点，你写的日记将被隐藏，包括你自己在内任何人都无法浏览。">这是什么?
                    ...
                    <div class="form-group">
                        ...
                        <input name="daybookimgUrl" type="file" id="exampleInputFile">
                    </div>
